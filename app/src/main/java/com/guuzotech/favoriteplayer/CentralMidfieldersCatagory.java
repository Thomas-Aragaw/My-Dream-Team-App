...
public class CentralMidfieldersCatagory extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_centralmidfielders_catagory);
        ...
        try {
            ...
            cursor = db.query("PLAYER",
                    new String[]{"_id", "NAME"},
                    "POSITION = ?", new String[] {"CentralMidfielders"}, null, null, null);
...
//Pass the drink the user clicks on to DrinkActivity
                        ...
                        Intent intent = new Intent(CentralMidfieldersCatagory.this, forward.class);
