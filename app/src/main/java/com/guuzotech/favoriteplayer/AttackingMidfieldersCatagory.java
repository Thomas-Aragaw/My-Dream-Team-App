...
public class AttackingMidfieldersCatagory extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_attackingmidfelders_catagory);
        ...
        try {
            ...
            cursor = db.query("PLAYER",
                    new String[]{"_id", "NAME"},
                    "POSITION = ?", new String[] {"AttackingMidfielders"}, null, null, null);
...
//Pass the drink the user clicks on to DrinkActivity
                        ...
                        Intent intent = new Intent(AttackingMidfieldersCatagory.this, forward.class);
