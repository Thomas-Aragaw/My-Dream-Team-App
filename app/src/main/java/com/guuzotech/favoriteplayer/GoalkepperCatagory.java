...
public class GoalkepperCatagory extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_goalkepper_catagory);
        ...
        try {
            ...
            cursor = db.query("PLAYER",
                    new String[]{"_id", "NAME"},
                    "POSITION = ?", new String[] {"Goalkeeper"}, null, null, null);
...
//Pass the drink the user clicks on to DrinkActivity
                        ...
                        Intent intent = new Intent(GoalkepperCatagory.this, goalkepper.class);
