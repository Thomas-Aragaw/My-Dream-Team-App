...
public class ForwardCatagory extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_forward_catagory);
        ...
        try {
            ...
            cursor = db.query("PLAYER",
                    new String[]{"_id", "NAME"},
                    "POSITION = ?", new String[] {"Forward"}, null, null, null);
...
//Pass the drink the user clicks on to DrinkActivity
                        ...
                        Intent intent = new Intent(ForwardCatagory.this, forward.class);
