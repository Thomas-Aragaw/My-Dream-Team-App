...
public class WingersCatagory extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_wingers_catagory);
        ...
        try {
            ...
            cursor = db.query("PLAYER",
                    new String[]{"_id", "NAME"},
                    "POSITION = ?", new String[] {"Wingers"}, null, null, null);
...
//Pass the drink the user clicks on to DrinkActivity
                        ...
                        Intent intent = new Intent(WingersCatagory.this, forward.class);
